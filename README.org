...
#+END_SRC
For unloading plugins, you may use =trigger-hook= with the hook argument =:unload=. Refer to [[Triggering Hooks]]
**** Hooks
...
#+END_SRC
<<Triggering Hooks>>Of course, hooks aren't useful if you can't use them, you can trigger a hook
